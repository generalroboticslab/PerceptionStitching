...
def main(args):
    ...
    if args.config is not None:
        ...
        # previous codes lock the key. Now I unlock it and allow to add new keys like "device"
    ...
    # get torch device
    device = TorchUtils.get_torch_device(try_to_use_cuda=config.train.cuda, device=config.train.device)
