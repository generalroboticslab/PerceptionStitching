    ...
    def _load_model(self):
        ...
        if self.placement_initializer is not None:
            ...
            self.placement_initializer = UniformRandomSampler(
                ...
                x_range=[0.07999, 0.08001],  # [0.07, 0.09]
                y_range=[-0.00001, 0.00001],  # [-0.01, 0.01]
                rotation=(-np.pi / 2.0 - 0.00001, -np.pi / 2.0),  # (-np.pi / 2.0 - 0.25, -np.pi / 2.0)
                rotation_axis="z",
