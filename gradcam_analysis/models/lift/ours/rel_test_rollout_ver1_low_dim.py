...
robot0_eye_in_hand_image_encoder_path = 'saved_models/lift/bc_rel_ver1_' + args.vision1_suffix + '_anchors' + str(args.anchor_num) + '_lr0.0001_seed101_model.pt'
agentview_image_encoder_path = 'saved_models/lift/bc_rel_ver1_' + args.vision2_suffix + '_anchors' + str(args.anchor_num) + '_lr0.0001_seed101_model.pt'
gmm_mlp_path = 'saved_models/lift/bc_rel_ver1_' + args.mlp_suffix + '_anchors' + str(args.anchor_num) + '_lr0.0001_seed101_model.pt'
