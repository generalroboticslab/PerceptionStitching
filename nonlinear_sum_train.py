...
from nn_modules.resnet18_gmmmlp_view13rgb_rel_model_low_dim_nonlinear_sum import PiNetwork
...
if args.log:
    writer = SummaryWriter('training_data/lift_pes2_nonlinear_sum_vision1' + args.vision1 + '_vision2' + args.vision2 + '_anchors' + str(args.anchor_num) + '_lr' + str(args.lr) + '_seed' + str(args.seed))
...
if args.save_model:
    ...
    if not os.path.exists(model_path):
        os.mkdir(model_path)
    model_file_name = 'pes2_nonlinear_sum_vision1' + args.vision1 + '_vision2' + args.vision2 + '_anchors' + str(args.anchor_num) + '_lr' + str(args.lr) + '_seed' + str(args.seed) + '_model.pt'
