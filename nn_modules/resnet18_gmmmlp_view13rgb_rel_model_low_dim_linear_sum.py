...
# Aggregate the four distances with linear weights
# CO-0.75, L1-0.1, L2-0.1, L_infinite-0.05
...
class Resnet18SpatialSoftmax(nn.Module):
    ...
    def forward(self, x):
        ...
        # multiply weights to different distances
        cos_distance = cos_distance * 0.75
        l1_distance = l1_distance * 0.1
        l2_distance = l2_distance * 0.1
        linf_distance = linf_distance * 0.05
